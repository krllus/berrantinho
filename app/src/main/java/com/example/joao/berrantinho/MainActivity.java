    ...
    switch (view.getId()) {
      ...
      case R.id.show_number:
        ...
        try {
          ...
          double dobro = d * 2;
          Toast.makeText(this, String.format(Locale.getDefault(), "%f <-> %f ", d, dobro),
      ...
      case R.id.launch_dialog_2:
        AlertDialog dialog = new AlertDialog.Builder(this, R.style.AlertDialogTheme)
            .setTitle("Such Title")
            .setMessage(
                "such message, much wow, with long text... 3,6,9, dam she's fine. to the windownwwww to the wall, to that wall")
