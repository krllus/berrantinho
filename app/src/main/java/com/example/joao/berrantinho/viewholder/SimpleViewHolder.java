...
public class SimpleViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bindView(Simple element, HashSet<String> selectedIds) {
        ...
        if (selectedIds.contains(element.getId())) {
            itemView.setForeground(new ColorDrawable(ContextCompat.getColor(context, R.color.colorControlActivated)));
        } else {
            itemView.setForeground(new ColorDrawable(ContextCompat.getColor(context, android.R.color.transparent)));
        }
    }
}
