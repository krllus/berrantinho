...
public class NotificationIntentService extends IntentService {
  ...
  private static final String EXTRA_NOTIFICATION_CHANNEL_ID =
      "notification.extra.NOTIFICATION_CHANNEL_ID";
   ...
   */
  public static void startNotification(Context context, NotificationBase notification,
      int notificationID, String channel) {
  ...
  private void handleStartNotification(NotificationBase notificationBase, int notificationID,
      String channel) {
  ...
  private void stackNotificationsIfNeeded(NotificationBase notification) {
    ...
    if (groupedNotifications.size() > 1) {
      ...
      builder.setContentTitle(
          String.format("%s: %s", notification.getTitle(), notification.getSubtitle()))
      ...
      NotificationCompat.InboxStyle inbox = new NotificationCompat.InboxStyle();
      {
        for (StatusBarNotification statusBarNotification : groupedNotifications) {
          String stackNotificationLine =
              (String) statusBarNotification.getNotification().extras.get(
