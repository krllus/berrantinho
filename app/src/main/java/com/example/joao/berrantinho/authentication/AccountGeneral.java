...
public class AccountGeneral {
    ...
    public static final String AUTHTOKEN_TYPE_READ_ONLY_LABEL = "Read only access to an " + ACCOUNT_NAME + " account";
    public static final String AUTHTOKEN_TYPE_FULL_ACCESS = "Full access";
    public static final String AUTHTOKEN_TYPE_FULL_ACCESS_LABEL = "Full access to an " + ACCOUNT_NAME + " account";
